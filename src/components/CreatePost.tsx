...
export default function CreatePost() {
  ...
  return (
    <div className="create-post-view" style={{ display: 'flex', flexDirection: 'column', height: '100%', padding: '20px 20px 100px 20px', overflowY: 'auto' }}>
      ...
      <div style={{ flex: 1, display: 'flex', flexDirection: 'column', width: '100%' }}>
        ...
        {isCropping ? (
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '20px', height: '100%' }}>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '16px', background: 'rgba(255,255,255,0.05)', padding: '16px', borderRadius: '16px' }}>
                  ...
                  {(['everyone', 'friends', 'private'] as const).map(s => (
                    <button 
                      ...
                      style={{ 
                        ...
                        color: 'white', fontWeight: 'bold', cursor: 'pointer', fontFamily: 'inherit', fontSize: '0.8rem'
                      }}
                    >
                ...
                {hasImages && (
                  <button
                    ...
                    style={{ 
                      ...
                      background: 'var(--color-lavender)', color: 'white', border: 'none', borderRadius: '50%', width: 40, height: 40, display: 'flex', alignItems: 'center', justifyContent: 'center', cursor: 'pointer' 
                    }}
                  >
