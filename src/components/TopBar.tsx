      ...
      <div className="top-actions" style={{ display: 'flex', alignItems: 'center', gap: '8px', position: 'relative' }} ref={menuRef}>
        ...
        {showMenu && (
          <div className="dropdown-menu" style={{
            ...
            <button className="dropdown-item" onClick={() => { setShowMenu(false); window.dispatchEvent(new CustomEvent('navigate', { detail: { view: 'search', tab: 'users' } })); }}>Search Users</button>
